 ...
 */
public abstract class RegistrationClient implements RequestEntity, Response.Listener, Response.ErrorListener {
    ...
    public RegistrationClient(Activity activity) {
    ...
    public Map<String, String> getParams() {
        ...
        localParams.put("lat", driver.lat);
        localParams.put("lng", driver.lng);
        return localParams;
    }
