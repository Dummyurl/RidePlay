...
/**
 * Created by rnf-new on 30/1/17.
 */

public abstract class CheckOutClient implements RequestEntity, Response.Listener, Response.ErrorListener {
    ...
    public CheckOutClient(Activity activity) {
        this.activityWeakReference = new WeakReference<Activity>(activity);
    }

    public void setParams(String phoneno) {
...
//                GlobalUtils.logout(activity, message);
    ...
    public String getUrl() {
        return NetworkUrls.SEND_CHECKOUT;
    }
