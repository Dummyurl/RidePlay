 ...
 */
public abstract class ForgotPasswordClient implements RequestEntity, Response.Listener, Response.ErrorListener {
    ...
    public ForgotPasswordClient(Activity activity) {
    ...
    public String getUrl() {
        return NetworkUrls.FORGOT_PASSWORD;
    }
